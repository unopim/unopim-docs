// .vitepress/version-configs/3.1.ts
let version = '3.1'
...
export default [
    {
        ...
        items: setVersionPrefix([
            ['prologue/release-notes', 'Release Notes'],
    ...
    },
    {
        ...
        items: setVersionPrefix([
            ...
            ['introduction/glossary', 'Glossary'],
            ['introduction/installation', 'Installation'],
            ['introduction/installation-with-mariadb', 'Installation with MariaDB'],
    ...
    },
    {
        ...
        items: setVersionPrefix([
            ...
            ['architecture/data-model', 'Data Model & Values Format'],
    ...
    },
    {
        ...
        items: setVersionPrefix([
            ...
            ['packages/configurable-associations', 'Configurable Associations'],
            ['packages/advanced-variants', 'Advanced Variants'],
            ['packages/measurements', 'Measurements'],
            ['packages/resource-crud-kit', 'Resource CRUD Kit'],
            ...
            ['packages/testing', 'Testing Packages'],
    ...
    },
    {
        ...
        items: setVersionPrefix([
            ...
            ['advanced/system-settings', 'System Settings Hub'],
            ['advanced/performance-scalability', 'Performance & Scalability'],
    ...
    },
    {
        ...
        collapsed: false,
        items: setVersionPrefix([
            ['api/whats-new-v3', "What's New in v3.1"],
