...
- **Dashboard**
    ...
    - Channel readiness indicators showing product completeness across channels.
    - Product trend charts tracking creation and update activity over time.
    - Activity feeds displaying recent product, category, and user actions.
...
- **Configuration and Settings**
    ...
    - Agentic PIM configuration for AI agent behavior, approval workflows, and auto-enrichment settings.
...
The **DataTransfer** package manages data imports and exports, facilitating bulk operations such as importing large volumes of product information. For more details, see the [DataTransfer documentation](/2.0/packages/data-transfer).
...
* **Multi-platform support** via the LaravelAiAdapter, allowing seamless switching between AI providers
