...
Register your package's service provider in the **`bootstrap/providers.php`** file located in the root directory of your UnoPim application. Add your service provider class to the returned array:
...
::: warning Note
In Laravel 12, service providers are registered in `bootstrap/providers.php` instead of the `config/app.php` providers array used in earlier versions. If you are upgrading from a previous version, make sure to move your provider registrations accordingly.
:::
