...
This page contains the raw UnoPim Postman collection in JSON form, so you can copy it straight into Postman without downloading a file. Save the block below as a `.json` file, or paste it into Postman's Import dialog, and see [Configuration](configuration#set-up-postman) for the full setup walkthrough.

The collection covers the product listing request plus both authentication flows:
