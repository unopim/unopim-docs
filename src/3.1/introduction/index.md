...
::: tip What's new in v3.1
v3.1 adds first-class MariaDB support and extends the REST API. See the [3.1 release notes](../prologue/release-notes) and [MariaDB installation guide](installation-with-mariadb).
:::

::: tip Features introduced in v3.0
