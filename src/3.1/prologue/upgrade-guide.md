...
::: info Upgrading within 3.x
For 3.0.x to 3.1.x, follow the [Patch / Minor Update Guide](patch-update). The major-upgrade steps below cover the transition from 2.1.x to 3.0; complete that transition before updating to 3.1.
:::
