...
::: warning Note
In Laravel 13, service providers are registered in `bootstrap/providers.php` instead of the `config/app.php` providers array used in earlier versions. If you are upgrading from a previous version, make sure to move your provider registrations accordingly.
:::
