...
::: tip
Upgrading across a major version (for example `1.x → 2.x`)? Switch to the **2.0.x** documentation and follow its [Upgrade Guide](/2.0/prologue/upgrade-guide), which covers the Laravel 12 and PHP 8.3 migration. Once you are on v2.0.x, return here to move up to v2.1.0.
:::
...
::: warning
If you are still on **v1.0.0**, do not use this guide. Complete the [v1.x → v2.0.0 upgrade](/2.0/prologue/upgrade-guide) first, then return here to upgrade to v2.1.0.
:::
