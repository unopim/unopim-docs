<template>
  <div class="theme-container" style="padding-right: 20px;">
    <div class="theme-default-content">
      <img src="/logo.png" alt="UnoPim Documentation" class="logo" style="height: 86px; width: 200px;">
...
<script>
const msgs = [
  `This page does not exist for this version of UnoPim but was found in other versions.`,
]
